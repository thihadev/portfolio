...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center xl:bg-secondary p-1 text-muted-foreground rounded-[30px]",
      className
    )}
    {...props} />
))
